...
def solicitar_introducir_numero(invite, minimum, maximum):
...
# PARTE 1
numero = solicitar_introducir_numero("Introduzca el número a adivinar", MIN, MAX)
...
while True:
    ...
    intento = solicitar_introducir_numero("Adivine el número", MIN, MAX)
